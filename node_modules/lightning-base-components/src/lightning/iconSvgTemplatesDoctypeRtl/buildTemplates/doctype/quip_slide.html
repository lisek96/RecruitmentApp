<template>
    <svg class={computedClass} focusable="false" data-key={name} aria-hidden="true" viewBox="0 0 56 64" part="icon">
        <g>
 <path fill-rule="evenodd" clip-rule="evenodd" fill="#8D3DF5" d="M0 5.1v53.7C0 61.7 2.3 64 5.1 64h45.7c2.8 0 5.1-2.3 5.1-5.1V21L37 0H5.1C2.3 0 0 2.3 0 5.1z"></path>
 <path opacity=".5" fill="#FFF" d="M37 0l19 21H42.1c-2.8 0-5.2-2.3-5.2-5.2L37 0z"></path>
 <path opacity=".5" fill="#6D2BD6" d="M37 15.9v1c0 2.8 2.3 5.2 5.2 5.2H56v-1H42.1c-2.8-.1-5.1-2.4-5.1-5.2z"></path>
